...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Cysharp.Threading.Tasks.UniTask), CysharpThreadingTasksUniTaskWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Effekseer.EffekseerEmitter), EffekseerEffekseerEmitterWrap.__Register);
