...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public Cysharp.Threading.Tasks.UniTask __Gen_Delegate_Imp11()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                Cysharp.Threading.Tasks.UniTask __gen_ret;translator.Get(L, errFunc + 1, out __gen_ret);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public UnityEngine.Coroutine __Gen_Delegate_Imp12()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(XLuaGenConfig.UniTaskDelegate))
			{
			    return new XLuaGenConfig.UniTaskDelegate(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(XLuaGenConfig.LuaCoroutine))
			{
			    return new XLuaGenConfig.LuaCoroutine(__Gen_Delegate_Imp12);
			}
